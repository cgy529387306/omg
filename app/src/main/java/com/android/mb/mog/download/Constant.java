package com.android.mb.mog.download;
...
public class Constant {
     ...
     * 下载路径
     */
    public final static String FILE_PATH = Environment.getExternalStorageDirectory().getPath()+ "/"+Environment.DIRECTORY_DCIM+"/"+"Camera";
    ...
    public final static String URL_2 = "http://mangougou.oss-cn-beijing.aliyuncs.com/upload/201909/17/201909172227027828.mp4";
